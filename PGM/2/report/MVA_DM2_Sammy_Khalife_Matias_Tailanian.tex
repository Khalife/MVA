...
\centering
  \subfloat[Random initialization 1]{\label{fig:3a} 
  		\includegraphics[width=.48\textwidth]{./pics/3a.pdf}} 
  \subfloat[Random initialization 2]{\label{fig:3a2} 
  		\includegraphics[width=.48\textwidth]{./pics/3a2.pdf}} \\
...
\centering
  \subfloat[Far random initialization 1]{\label{fig:3aLejos} 
  		\includegraphics[width=.48\textwidth]{./pics/3aLejos.pdf}} 
  \subfloat[Far random initialization 2]{\label{fig:3aLejos2} 
  		\includegraphics[width=.48\textwidth]{./pics/3aLejos2.pdf}} \\
